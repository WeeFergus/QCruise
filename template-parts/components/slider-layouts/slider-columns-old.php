<?php
  ...
  $slider_category_link = get_category_link($slider_category); 
?>
            ...
            <div class="featured-item-box-inner">
                  ...
                  <div class="featured-item-meta">
                    ...
                    <?php if ( $slider_date_toggle == 1 ) : ?>
                      <div class="featured-item-meta-date">
                        <i class="material-icons">&#xE8B5;</i>
                        <a href="<?php echo esc_url($slider_category_link); ?>"><?php echo get_the_date(); ?></a>
                      </div>
                    <?php endif; ?>
              ...
              <div class="title-wrapper">
                <div class="featured-item-title">
                  <h2><a href="<?php echo esc_url($slider_category_link); ?>"><?php the_title(); ?></a></h2>
                </div>
              </div>
              <?php if ( $slider_button_toggle == 1 ) : ?>
                <div class="featured-item-more-link">
                  <div class="button-wrapper">
                    <a href="<?php echo esc_url($slider_category_link); ?>"><?php echo esc_html( get_theme_mod( 'halcyon_slider_button_text', esc_html__('Read More', 'halcyon-wp') ) ); ?></a>
                  </div>
                </div>
              <?php endif; ?>
            </div>
